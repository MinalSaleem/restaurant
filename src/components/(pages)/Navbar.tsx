    ...
    <div className="absolute max-w-full mt-[15px] bg-[#0D0D0D] w-full flex justify-between items-center px-4 sm:px-8 h-[32px]">
      ...
      <div className="hidden md:flex max-w-[508px]">
        <ul className="flex gap-2 sm:gap-4">
          <li className="font-bold font-helvetica text-[#FF9F0D] text-[24px] sm:text-[16px]">
            <Link href="/">Home</Link>
          </li>
          <li className="font-normal font-helvetica text-[#ffffff] text-[24px] sm:text-[16px]">
        ...
        <Sheet>
          ...
          <SheetContent>
            <ul className="flex flex-col text-[#ffffff] md:flex-row gap-4 p-4">
              <li className="font-bold font-helvetica text-[#FF9F0D] text-[16px] sm:text-[16px]">
                <Link href="/">Home</Link>
              </li>
              <li className="font-bold font-helvetica text-[#ffffff] text-[16px] sm:text-[16px]">
                <Link href="/menu">Menu</Link>
              </li>
              <li className="font-bold font-helvetica text-[#ffffff] text-[16px] sm:text-[16px]">
                <Link href="/blog">Blog</Link>
