...
export default function CheckoutPage() {
  ...
  return (
    <div>
      <Header title="Cheekout" route="Cheekout" />
              ...
              <div className="md:w-1/2 px-4 w-full">
                ...
                <div className="w-[235px]">
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  >
                    <option value="" className="w-full px-3">
                      Choose country
                    </option>
                    <option value="us" className="w-full px-3">
                      United States
                    </option>
                    <option value="uk" className="w-full px-3">
                      United Kingdom
                    </option>
                    <option value="ca" className="w-full px-3">
                      Canada
                    </option>
                    <option value="pa" className="w-full px-3">
                      Pakistan
                    </option>
                  </select>
                </div>
